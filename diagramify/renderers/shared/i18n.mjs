...
const MESSAGE_PAIRS = {
  ...
  'diagram.description.architecture': ['An architecture diagram generated by Diagramify.', '由 Diagramify 生成的架构图。'],
  'diagram.description.workflow': ['A workflow diagram generated by Diagramify.', '由 Diagramify 生成的工作流图。'],
  'diagram.description.sequence': ['A sequence diagram generated by Diagramify.', '由 Diagramify 生成的时序图。'],
  'diagram.description.dataflow': ['A data-flow diagram generated by Diagramify.', '由 Diagramify 生成的数据流图。'],
  'diagram.description.lifecycle': ['A lifecycle diagram generated by Diagramify.', '由 Diagramify 生成的生命周期图。'],
  'diagram.description.explainer-steps': ['A step-by-step explainer generated by Diagramify.', '由 Diagramify 生成的分步说明图。'],
  ...
  'node.context.explainer-steps': ['Explainer step', '说明步骤'],
  ...
  'legend.explainer-steps.start': ['start', '开始'],
  'legend.explainer-steps.active': ['in progress', '进行中'],
  'legend.explainer-steps.waiting': ['waiting / blocked', '等待 / 阻塞'],
  'legend.explainer-steps.decision': ['decision point', '决策点'],
  'legend.explainer-steps.success': ['successful outcome', '成功结果'],
  'legend.explainer-steps.failure': ['failure / warning', '失败 / 警告'],
  'legend.explainer-steps.neutral': ['informational', '信息性说明'],
  'legend.explainer-steps.external': ['external actor', '外部参与者'],
  ...
  'viewer.preset.badge.editorialPlate': ['DIAGRAMIFY / PLATE 04', 'DIAGRAMIFY / 图版 04'],
  ...
  'viewer.export.card.routeBadge': ['DIAGRAMIFY · ROUTE · {hops}', 'DIAGRAMIFY · 路径 · {hops}'],
  'viewer.export.card.reachBadge': ['DIAGRAMIFY · {direction} REACH', 'DIAGRAMIFY · {direction}可达范围'],
  'viewer.export.card.defaultBadge': ['DIAGRAMIFY · {preset} · {theme}', 'DIAGRAMIFY · {preset} · {theme}'],
...
for (const [key, messages] of Object.entries(MESSAGE_PAIRS)) {
  if (messages.length !== SUPPORTED_LOCALES.length || messages.some((message) => typeof message !== 'string')) {
    throw new Error(`Incomplete Diagramify i18n tuple ${JSON.stringify(key)}`);
  }
}
...
export function translateMessage(locale, key, values = {}) {
  ...
  if (!Object.hasOwn(CATALOGS[resolved], key)) {
    throw new Error(`Missing Diagramify i18n message ${JSON.stringify(key)} for ${resolved}`);
  }
