...
test('repository language metadata separates generated artifacts from implementation source', () => {
  for (const generatedPath of [
    'diagramify/examples/web-app-rendered.html',
    ...
    'diagramify/renderers/shared/generated-brand-marks.mjs',
    'diagramify/renderers/shared/generated-validators.mjs',
  ]) {
    assert.equal(
  ...
  for (const sourcePath of [
    ...
    'docs/index.html',
    'diagramify/renderers/shared/geometry.mjs',
  ]) {
    assert.equal(
